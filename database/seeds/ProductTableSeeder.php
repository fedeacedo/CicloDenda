    ...
    public function run()
    {
        $data = array(
			[
				...
				'extract' 		=> 'Hemos mejorado el cuadro, agregado nuevas características e incluso ganado más premios. ',
				'price' 		=> 5249.99,
			...
			[
				...
				'price' 		=> 3399.99,
				'image' 		=> 'http://chainreactioncycles.scene7.com/is/image/ChainReactionCycles/prod145993_IMGSET?wid=500&hei=505',
				'visible' 		=> 1,
				'created_at' 	=> new DateTime,
				'updated_at' 	=> new DateTime,
				'category_id' 	=> 1
